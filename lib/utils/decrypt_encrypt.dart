...
class DecryptUtil {
  ...
  static Future<WalletItemEncrypted> decryptFrom(WalletItemEncrypted walletItemEncrypted) async {
    ...
    walletItemEncrypted.lockerName.lockerName=lockerNameClear;
    walletItemEncrypted.userName.userName=userNameClear;
    walletItemEncrypted.password.password=passwordClear;
    return walletItemEncrypted;
